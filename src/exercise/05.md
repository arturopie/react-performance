...
What's are good ways of visualizing React code? For example, we use UML Class and Sequence diagrams for OOP, how about React code? What visualization could help us explain and see options for refactoring?
