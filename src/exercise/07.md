...
> User complaints is not a great policy for quality
control.

Is the idea to have many Profilers all around the app to profile individual components?

My React profiler does not show "Profiled interactions". Anyone else?
